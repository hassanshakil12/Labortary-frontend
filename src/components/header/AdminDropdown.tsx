...
//           <img src="/images/notification-icon.png" alt="Notification" className="h-8 w-8" />
//         </span>
//       </Link>

//       {/* User Avatar */}
//       <div>
//         <div onClick={() => setOpen(!open)} className="overflow-hidden rounded-full h-11 w-11 cursor-pointer flex items-center justify-center bg-white">
//           <img src="/images/profile_img.svg" alt="User" className="h-11 w-11 object-cover" />
//         </div>
